...
- Project folder name: `<workspace>/excalidraw`.
...
- The skill should persist the latest diagram in `<workspace>/excalidraw/state` or `CODEX_EXCALIDRAW_STATE_DIR` to support incremental edits without redrawing from scratch.
